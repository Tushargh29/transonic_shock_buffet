...
ax.set_title(r'Airfoil surface pressure coefficient (Experimental) for dataset-1',fontsize=fontsize_label1)
#ax.legend()

# save as PDF for general usage, e.g., inclusion in Latex documents
plt.savefig("Airfoil surface pressure coefficient (Experimental) for dataset-1", bbox_inches="tight")
