...
data0 = pd.read_csv('Set4_upper.csv', delimiter=',')                     
data1 = pd.read_csv('Set4_lower.csv', delimiter=',')                 
...
ax.set_title(r'Airfoil surface pressure coefficient (Experimental) for dataset-4',fontsize=fontsize_label1)
#ax.legend()

# save as PDF for general usage, e.g., inclusion in Latex documents
plt.savefig("Airfoil surface pressure coefficient (Experimental) for dataset-4", bbox_inches="tight")
